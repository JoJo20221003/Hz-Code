...
H1,H2,H3,H4,H5,H6,H7 = np.loadtxt('bin7_h_4000_Om0.3.txt', unpack=True, usecols=(0, 1,2,3,4,5,6))

x=np.vstack((H1,H2,H3,H4,H5,H6,H7))
H_cov=np.cov(x)
print("H_cov\n",H_cov)
...
print("cov_new\n",cov_new)
np.savetxt('bin7_h_decorr.txt', H_new, fmt='%5.6f')